...
#SBATCH -J vlm3r_arkitscenes_extract_1gpu
...
python $REPO/scripts/extract_spatial_features.py \
  --input-dir /leonardo_scratch/fast/EUHPC_D32_006/data/vlm3r/arkitscenes/videos \
  --output-dir /leonardo_scratch/fast/EUHPC_D32_006/data/vlm3r/arkitscenes/spatial_features \
