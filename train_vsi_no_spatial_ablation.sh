...
# ============================================================
NOTE="No-spatial ablation: no spatial tower or fusion block at all (pure SigLIP + mm_projector + LoRA), 25% data, 1 epoch"
...
# ============================================================
# NOTE: No spatial tower or fusion block — this is a pure 2D ablation.
# The model runs: SigLIP vision tower → mm_projector → LLM (with LoRA).
# No Pi3X / CUT3R spatial encoder is loaded or initialized.
...
MODEL_MM_VISION_SELECT_LAYER="-1"
...
echo "[ABLATION] NO_SPATIAL: spatial tower and fusion block are NOT initialized."
echo "[ABLATION] Pipeline: SigLIP vision tower -> mm_projector -> LLM (LoRA fine-tuned)"
