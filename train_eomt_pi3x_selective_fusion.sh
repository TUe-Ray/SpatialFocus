#!/bin/bash
#SBATCH --job-name=SMOKE_eomt_selective_soft_with_floor_zero_fallback
#SBATCH --nodes=1
...
# ============================================================
NOTE="eomt selective_3d_round1 selective_soft_with_floor_zero_fallback integration, 25% data, 1 epoch"
