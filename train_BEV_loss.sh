...
MODEL_USE_BEV_SUPERVISION="${MODEL_USE_BEV_SUPERVISION:-True}"
...
echo "[DEPTH] ENABLE=$MODEL_USE_DEPTH_SUPERVISION LAMBDA_DEPTH=$MODEL_LAMBDA_DEPTH SOURCE=$MODEL_DEPTH_HEAD_SOURCE POINT_MAP=$MODEL_DEPTH_POINT_MAP_KEY MAX_GT=$MODEL_DEPTH_MAX_GT"
