...
#SBATCH -J vlm3r_scannetpp_extract_1gpu
...
python $REPO/scripts/extract_spatial_features.py \
  --input-dir /leonardo_scratch/fast/EUHPC_D32_006/data/vlm3r/scannetpp/videos \
  --output-dir /leonardo_scratch/fast/EUHPC_D32_006/data/vlm3r/scannetpp/spatial_features \
