#!/bin/bash
#SBATCH --job-name=Eval_zero_spatial
#SBATCH --nodes=1
...
NOTE="Eval ablation with zero_spatial_features=True (spatial features zeroed at inference)"
echo "-------- Note --------"
echo "  note: $NOTE"

PRETRAINED_LOCAL="/leonardo_work/EUHPC_D32_006/Train_Model/VLM3R/ablation_no_spatial_25p_39895083"


RUN_NAME="${RUN_NAME:-${SLURM_JOB_NAME:-Eval_zero_spatial}}"
...
MODEL_ARGS+=",conv_template=$CONV_TEMPLATE,max_frames_num=$MAX_FRAMES_NUM,zero_spatial_features=True"
