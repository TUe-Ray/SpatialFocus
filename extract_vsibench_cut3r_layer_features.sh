#!/bin/bash
#SBATCH --job-name=Extract_VSI_CUT3R_DecM2M4
#SBATCH --nodes=1
...
NOTE="Pre-extract CUT3R decoder-layer token sidecars for the VSI-Bench eval videos. This is needed before evaluating the dec_m2/dec_m4 layer-ablation checkpoints."
echo "-------- Note --------"
echo "  note: $NOTE"
...
echo "==== CUT3R decoder-layer extraction config ===="
date
...
echo "[DONE] CUT3R decoder-layer sidecars written under $OUTPUT_ROOT/*/spatial_features_dec_m{2,4}"
